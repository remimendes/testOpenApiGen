...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.NetworkList();
  });
  ...
  describe('NetworkList', function() {
    it('should create an instance of NetworkList', function() {
      // uncomment below and update the code to test NetworkList
      //var instance = new TestOpensvcAgentApi.NetworkList();
      //expect(instance).to.be.a(TestOpensvcAgentApi.NetworkList);
    });
