...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.NetworkIP();
  });
  ...
  describe('NetworkIP', function() {
    it('should create an instance of NetworkIP', function() {
      // uncomment below and update the code to test NetworkIP
      //var instance = new TestOpensvcAgentApi.NetworkIP();
      //expect(instance).to.be.a(TestOpensvcAgentApi.NetworkIP);
    });
