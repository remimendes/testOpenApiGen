...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.DaemonSubsystemAlert();
  });
  ...
  describe('DaemonSubsystemAlert', function() {
    it('should create an instance of DaemonSubsystemAlert', function() {
      ...
      //var instance = new TestOpensvcAgentApi.DaemonSubsystemAlert();
      //expect(instance).to.be.a(TestOpensvcAgentApi.DaemonSubsystemAlert);
    });
