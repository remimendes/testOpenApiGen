...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpensvcAgentApi.PostObjectActionSwitch();
  });
  ...
  describe('PostObjectActionSwitch', function() {
    it('should create an instance of PostObjectActionSwitch', function() {
      ...
      //var instance = new OpensvcAgentApi.PostObjectActionSwitch();
      //expect(instance).to.be.a(OpensvcAgentApi.PostObjectActionSwitch);
    });
