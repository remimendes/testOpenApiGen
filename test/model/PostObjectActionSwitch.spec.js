...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.PostObjectActionSwitch();
  });
  ...
  describe('PostObjectActionSwitch', function() {
    it('should create an instance of PostObjectActionSwitch', function() {
      // uncomment below and update the code to test PostObjectActionSwitch
      //var instance = new TestOpensvcAgentApi.PostObjectActionSwitch();
      //expect(instance).to.be.a(TestOpensvcAgentApi.PostObjectActionSwitch);
    });
