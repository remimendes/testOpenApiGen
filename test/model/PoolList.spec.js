...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.PoolList();
  });
  ...
  describe('PoolList', function() {
    it('should create an instance of PoolList', function() {
      // uncomment below and update the code to test PoolList
      //var instance = new TestOpensvcAgentApi.PoolList();
      //expect(instance).to.be.a(TestOpensvcAgentApi.PoolList);
    });
