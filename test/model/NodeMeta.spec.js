...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.NodeMeta();
  });
  ...
  describe('NodeMeta', function() {
    it('should create an instance of NodeMeta', function() {
      // uncomment below and update the code to test NodeMeta
      //var instance = new TestOpensvcAgentApi.NodeMeta();
      //expect(instance).to.be.a(TestOpensvcAgentApi.NodeMeta);
    });
