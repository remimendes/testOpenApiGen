...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.PostRelayMessage();
  });
  ...
  describe('PostRelayMessage', function() {
    it('should create an instance of PostRelayMessage', function() {
      ...
      //var instance = new TestOpensvcAgentApi.PostRelayMessage();
      //expect(instance).to.be.a(TestOpensvcAgentApi.PostRelayMessage);
    });
