...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.SubsetConfig();
  });
  ...
  describe('SubsetConfig', function() {
    it('should create an instance of SubsetConfig', function() {
      ...
      //var instance = new TestOpensvcAgentApi.SubsetConfig();
      //expect(instance).to.be.a(TestOpensvcAgentApi.SubsetConfig);
    });
