...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.DaemonListener();
  });
  ...
  describe('DaemonListener', function() {
    it('should create an instance of DaemonListener', function() {
      // uncomment below and update the code to test DaemonListener
      //var instance = new TestOpensvcAgentApi.DaemonListener();
      //expect(instance).to.be.a(TestOpensvcAgentApi.DaemonListener);
    });
