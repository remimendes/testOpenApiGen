...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.DaemonCollector();
  });
  ...
  describe('DaemonCollector', function() {
    it('should create an instance of DaemonCollector', function() {
      ...
      //var instance = new TestOpensvcAgentApi.DaemonCollector();
      //expect(instance).to.be.a(TestOpensvcAgentApi.DaemonCollector);
    });
