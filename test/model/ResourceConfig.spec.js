...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.ResourceConfig();
  });
  ...
  describe('ResourceConfig', function() {
    it('should create an instance of ResourceConfig', function() {
      ...
      //var instance = new TestOpensvcAgentApi.ResourceConfig();
      //expect(instance).to.be.a(TestOpensvcAgentApi.ResourceConfig);
    });
