...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.RelayMessages();
  });
  ...
  describe('RelayMessages', function() {
    it('should create an instance of RelayMessages', function() {
      // uncomment below and update the code to test RelayMessages
      //var instance = new TestOpensvcAgentApi.RelayMessages();
      //expect(instance).to.be.a(TestOpensvcAgentApi.RelayMessages);
    });
