...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.DaemonDNS();
  });
  ...
  describe('DaemonDNS', function() {
    it('should create an instance of DaemonDNS', function() {
      // uncomment below and update the code to test DaemonDNS
      //var instance = new TestOpensvcAgentApi.DaemonDNS();
      //expect(instance).to.be.a(TestOpensvcAgentApi.DaemonDNS);
    });
