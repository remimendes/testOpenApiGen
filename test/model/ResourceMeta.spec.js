...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.ResourceMeta();
  });
  ...
  describe('ResourceMeta', function() {
    it('should create an instance of ResourceMeta', function() {
      // uncomment below and update the code to test ResourceMeta
      //var instance = new TestOpensvcAgentApi.ResourceMeta();
      //expect(instance).to.be.a(TestOpensvcAgentApi.ResourceMeta);
    });
