...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.DaemonSubsystemStatus();
  });
  ...
  describe('DaemonSubsystemStatus', function() {
    it('should create an instance of DaemonSubsystemStatus', function() {
      // uncomment below and update the code to test DaemonSubsystemStatus
      //var instance = new TestOpensvcAgentApi.DaemonSubsystemStatus();
      //expect(instance).to.be.a(TestOpensvcAgentApi.DaemonSubsystemStatus);
    });
