...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.DaemonMonitor();
  });
  ...
  describe('DaemonMonitor', function() {
    it('should create an instance of DaemonMonitor', function() {
      // uncomment below and update the code to test DaemonMonitor
      //var instance = new TestOpensvcAgentApi.DaemonMonitor();
      //expect(instance).to.be.a(TestOpensvcAgentApi.DaemonMonitor);
    });
