...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOpensvcAgentApi.DaemonHb();
  });
  ...
  describe('DaemonHb', function() {
    it('should create an instance of DaemonHb', function() {
      // uncomment below and update the code to test DaemonHb
      //var instance = new TestOpensvcAgentApi.DaemonHb();
      //expect(instance).to.be.a(TestOpensvcAgentApi.DaemonHb);
    });
