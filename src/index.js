...
* <pre>
* var OpensvcAgentApi = require('index'); // See note below*.
* var xxxSvc = new OpensvcAgentApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new OpensvcAgentApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new OpensvcAgentApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new OpensvcAgentApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
