...
/**
 * The DaemonListener model module.
 * @module model/DaemonListener
 * @version 3.12.2
 */
class DaemonListener {
    /**
     * Constructs a new <code>DaemonListener</code>.
     * @alias module:model/DaemonListener
    ...
    constructor(alerts, configured, createdAt, id, state) { 
        ...
        DaemonListener.initialize(this, alerts, configured, createdAt, id, state);
    }
    ...
    /**
     * Constructs a <code>DaemonListener</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DaemonListener} obj Optional instance to populate.
     * @return {module:model/DaemonListener} The populated <code>DaemonListener</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DaemonListener();
    ...
    /**
     * Validates the JSON data with respect to <code>DaemonListener</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DaemonListener</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DaemonListener.RequiredProperties) {
            if (!data[property]) {
...
DaemonListener.RequiredProperties = ["alerts", "configured", "created_at", "id", "state"];

/**
 * @member {Array.<module:model/DaemonSubsystemAlert>} alerts
 */
DaemonListener.prototype['alerts'] = undefined;

/**
 * @member {Date} configured
 */
DaemonListener.prototype['configured'] = undefined;

/**
 * @member {Date} created_at
 */
DaemonListener.prototype['created_at'] = undefined;

/**
 * @member {String} id
 */
DaemonListener.prototype['id'] = undefined;

/**
 * @member {String} state
 */
DaemonListener.prototype['state'] = undefined;
