...
/**
 * The DaemonCollector model module.
 * @module model/DaemonCollector
 * @version 3.12.9
 */
class DaemonCollector {
    /**
     * Constructs a new <code>DaemonCollector</code>.
     * @alias module:model/DaemonCollector
    ...
    constructor(alerts, configured, createdAt, id, state) { 
        ...
        DaemonCollector.initialize(this, alerts, configured, createdAt, id, state);
    }
    ...
    /**
     * Constructs a <code>DaemonCollector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DaemonCollector} obj Optional instance to populate.
     * @return {module:model/DaemonCollector} The populated <code>DaemonCollector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DaemonCollector();
    ...
    /**
     * Validates the JSON data with respect to <code>DaemonCollector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DaemonCollector</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DaemonCollector.RequiredProperties) {
            if (!data[property]) {
...
DaemonCollector.RequiredProperties = ["alerts", "configured", "created_at", "id", "state"];

/**
 * @member {Array.<module:model/DaemonSubsystemAlert>} alerts
 */
DaemonCollector.prototype['alerts'] = undefined;

/**
 * @member {Date} configured
 */
DaemonCollector.prototype['configured'] = undefined;

/**
 * @member {Date} created_at
 */
DaemonCollector.prototype['created_at'] = undefined;

/**
 * @member {String} id
 */
DaemonCollector.prototype['id'] = undefined;

/**
 * @member {String} state
 */
DaemonCollector.prototype['state'] = undefined;
...
export default DaemonCollector;
