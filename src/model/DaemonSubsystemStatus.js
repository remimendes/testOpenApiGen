...
/**
 * The DaemonSubsystemStatus model module.
 * @module model/DaemonSubsystemStatus
 * @version 3.12.2
 */
class DaemonSubsystemStatus {
    /**
     * Constructs a new <code>DaemonSubsystemStatus</code>.
     * @alias module:model/DaemonSubsystemStatus
    ...
    /**
     * Constructs a <code>DaemonSubsystemStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DaemonSubsystemStatus} obj Optional instance to populate.
     * @return {module:model/DaemonSubsystemStatus} The populated <code>DaemonSubsystemStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DaemonSubsystemStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>DaemonSubsystemStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DaemonSubsystemStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DaemonSubsystemStatus.RequiredProperties) {
            if (!data[property]) {
...
DaemonSubsystemStatus.RequiredProperties = ["alerts", "configured", "created_at", "id", "state"];
...
export default DaemonSubsystemStatus;
