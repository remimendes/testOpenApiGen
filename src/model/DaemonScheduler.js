...
/**
 * The DaemonScheduler model module.
 * @module model/DaemonScheduler
 * @version 3.12.19
 */
class DaemonScheduler {
    /**
     * Constructs a new <code>DaemonScheduler</code>.
     * @alias module:model/DaemonScheduler
    ...
    constructor(alerts, configured, createdAt, id, state) { 
        ...
        DaemonScheduler.initialize(this, alerts, configured, createdAt, id, state);
    }
    ...
    /**
     * Constructs a <code>DaemonScheduler</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DaemonScheduler} obj Optional instance to populate.
     * @return {module:model/DaemonScheduler} The populated <code>DaemonScheduler</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DaemonScheduler();
    ...
    /**
     * Validates the JSON data with respect to <code>DaemonScheduler</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DaemonScheduler</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DaemonScheduler.RequiredProperties) {
            if (!data[property]) {
...
DaemonScheduler.RequiredProperties = ["alerts", "configured", "created_at", "id", "state"];

/**
 * @member {Array.<module:model/DaemonSubsystemAlert>} alerts
 */
DaemonScheduler.prototype['alerts'] = undefined;

/**
 * @member {Date} configured
 */
DaemonScheduler.prototype['configured'] = undefined;

/**
 * @member {Date} created_at
 */
DaemonScheduler.prototype['created_at'] = undefined;

/**
 * @member {String} id
 */
DaemonScheduler.prototype['id'] = undefined;

/**
 * @member {String} state
 */
DaemonScheduler.prototype['state'] = undefined;
...
export default DaemonScheduler;
