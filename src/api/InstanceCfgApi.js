...
/**
* InstanceCfg service.
* @module api/InstanceCfgApi
* @version 3.12.2
*/
export default class InstanceCfgApi {

    /**
    * Constructs a new InstanceCfgApi. 
    * @alias module:api/InstanceCfgApi
    * @class
    ...
    */
     ...
     * @callback module:api/InstanceCfgApi~getInstanceCallback
     ...
     * @param {String} name 
     * @param {module:api/InstanceCfgApi~getInstanceCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/InstanceCfgApi~getInstanceLogsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/InstanceCfgApi~getInstanceLogsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/InstanceCfgApi~postInstanceActionDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/InstanceCfgApi~postInstanceActionDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/InstanceCfgApi~postInstanceClearCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/Kind} kind 
     * @param {String} name 
     * @param {module:api/InstanceCfgApi~postInstanceClearCallback} callback The callback function, accepting three arguments: error, data, response
     */
