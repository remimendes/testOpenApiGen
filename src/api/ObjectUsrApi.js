...
/**
* ObjectUsr service.
* @module api/ObjectUsrApi
* @version 3.12.9
*/
export default class ObjectUsrApi {

    /**
    * Constructs a new ObjectUsrApi. 
    * @alias module:api/ObjectUsrApi
    * @class
    ...
    */
     ...
     * @callback module:api/ObjectUsrApi~getObjectCallback
     ...
     * @param {String} name 
     * @param {module:api/ObjectUsrApi~getObjectCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectUsrApi~getObjectConfigCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ObjectUsrApi~getObjectConfigCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectUsrApi~getObjectConfigFileCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/Kind} kind 
     * @param {String} name 
     * @param {module:api/ObjectUsrApi~getObjectConfigFileCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectUsrApi~getObjectConfigGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ObjectUsrApi~getObjectConfigGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectUsrApi~postObjectActionAbortCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/Kind} kind 
     * @param {String} name 
     * @param {module:api/ObjectUsrApi~postObjectActionAbortCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectUsrApi~postObjectActionDeleteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrchestrationQueued} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/Kind} kind 
     * @param {String} name 
     * @param {module:api/ObjectUsrApi~postObjectActionDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrchestrationQueued}
     */
     ...
     * @callback module:api/ObjectUsrApi~postObjectConfigFileCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ObjectUsrApi~postObjectConfigFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/ObjectUsrApi~postObjectConfigUpdateCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ObjectUsrApi~postObjectConfigUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectUsrApi~putObjectConfigFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ObjectConfigFile} [objectConfigFile] OK
     * @param {module:api/ObjectUsrApi~putObjectConfigFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
