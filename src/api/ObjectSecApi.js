...
/**
* ObjectSec service.
* @module api/ObjectSecApi
* @version 3.12.9
*/
export default class ObjectSecApi {

    /**
    * Constructs a new ObjectSecApi. 
    * @alias module:api/ObjectSecApi
    * @class
    ...
    */
     ...
     * @callback module:api/ObjectSecApi~getObjectCallback
     ...
     * @param {String} name 
     * @param {module:api/ObjectSecApi~getObjectCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectSecApi~getObjectConfigCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ObjectSecApi~getObjectConfigCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectSecApi~getObjectConfigFileCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/Kind} kind 
     * @param {String} name 
     * @param {module:api/ObjectSecApi~getObjectConfigFileCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectSecApi~getObjectConfigGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ObjectSecApi~getObjectConfigGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectSecApi~postObjectActionAbortCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/Kind} kind 
     * @param {String} name 
     * @param {module:api/ObjectSecApi~postObjectActionAbortCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectSecApi~postObjectActionDeleteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrchestrationQueued} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/Kind} kind 
     * @param {String} name 
     * @param {module:api/ObjectSecApi~postObjectActionDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrchestrationQueued}
     */
     ...
     * @callback module:api/ObjectSecApi~postObjectConfigFileCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ObjectSecApi~postObjectConfigFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/ObjectSecApi~postObjectConfigUpdateCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ObjectSecApi~postObjectConfigUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ObjectSecApi~putObjectConfigFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ObjectConfigFile} [objectConfigFile] OK
     * @param {module:api/ObjectSecApi~putObjectConfigFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
